...
const checks = [
  ...
  { file: 'components/Hero.tsx', mustInclude: ['0 failing checks', '35 reviewed repos', '36 live demos', 'evidence/live/preview/aix-pilot.webp', 'type="image/webp"'] },
