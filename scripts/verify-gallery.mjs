...
const checks = [
  ...
  { file: 'components/Projects.tsx', mustInclude: ['<ServiceOffers', '<RepositoryCatalog', 'Built systems, with evidence', 'PORTFOLIO_REEL', 'REPOSITORY_DEMO_URLS', '<video', 'type="video/mp4"', 'isLivePngEvidence', 'evidence/live/preview/', 'evidence/live/preview-sm/', 'type="image/webp"', 'livePreviewFor', 'liveProofPreviewFor', 'Target user', 'How to verify', 'project.market', 'project.proofPath'] },
  { file: 'components/ServiceOffers.tsx', mustInclude: ['COMMERCIAL_LANES', 'commercial-lane-grid', 'free public proof', 'resourceUrlForLane', 'trackCommerceCtaClick', 'personal data is never sold', 'Starting prices are non-binding', 'lane_inquiry'] },
  { file: 'components/RepositoryCatalog.tsx', mustInclude: ['RESOURCE_WIRING', 'resource-wiring-panel', 'SERVICE_OFFERS', 'Repository proof and service routes', 'resourceUrlForRepo', 'Public proof boundary', 'PRIVATE_CASE_STUDY_REPOS', 'Private source'] },
  { file: 'components/InquiryForm.tsx', mustInclude: ['CANONICAL_INQUIRY_API', 'Private inquiry', 'Do not include credentials', 'INQUIRY_CONSENT_VERSION', 'INQUIRY_SOURCE_LANES', 'Submit private inquiry', 'Resource lane', 'probeInquiryApi', 'Private form temporarily unavailable', 'Contact privately on LinkedIn'] },
  ...
  { file: 'functions/api/events.ts', mustInclude: ['TELEMETRY_RATE_LIMIT_SALT', 'CF-Connecting-IP', 'telemetry_daily_counters'] },
