...
const checks = [
  ...
  { file: 'commercialLanes.ts', mustInclude: ['COMMERCIAL_LANES', 'Storefront Architecture Packs', 'AIX Governance Sprint', 'StagePilot Reliability Lab', 'AegisOps Response Room', 'Nexus Data Contract Lab', 'Document and SMB Ops Pilot', 'Industrial Regulated Validation Pack', 'Consumer Learning Supporter Lane', 'Digital Twin Ops Readiness', 'billingMode', 'priceAnchor', 'concreteDeliverable', 'resolveCheckoutUrl', 'commerceUrlForRepo', 'proofSignal'] },
  ...
  { file: 'docs/final-architecture-notes.md', mustInclude: ['nine commercial operating names', 'DaesikPage', 'Toss/PortOne/Stripe', 'Local build notes are captured in the repository scripts and build workflow.', '34 unique public demo URLs', '35 editable coverage repositories', 'public API proof cards', 'KIM3310', 'doeon-kim-portfolio'] },
