...
const checks = [
  ...
  { file: 'public/briefs/snowflake-review-brief.html', mustInclude: ['Snowflake', 'Nexus-Hive', 'Enterprise Kit'], mustNotInclude: ['FabPilot Live X', 'SignalForge'] },
  { file: 'public/briefs/databricks-review-brief.html', mustInclude: ['Databricks', 'The Logistics Prophet', 'Beaver'], mustNotInclude: ['FabPilot Live X', 'SignalForge'] },
