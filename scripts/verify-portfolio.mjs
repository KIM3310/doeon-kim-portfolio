...
const checks = [
  ...
  { file: 'README.md', mustInclude: ['StagePilot', 'FabTwin Guardian', 'Verified now', 'Repo operating map', 'https://kim3310.github.io/doeon-kim-portfolio/'], mustNotInclude: ['FabPilot Live X', 'SignalForge'] },
