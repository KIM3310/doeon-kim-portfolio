...
const checks = [
  ...
  { file: 'public/briefs/palantir-review-brief.html', mustInclude: ['Palantir', 'regulated-case-workbench', 'fab-ops-yield-control-tower'], mustNotInclude: ['FabPilot Live X', 'SignalForge'] },
