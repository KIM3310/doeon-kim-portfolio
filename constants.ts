...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    demo: 'https://kim3310.github.io/doeon-kim-portfolio/demos/twincity/',
    evidence: 'evidence/twincity-transport.svg',
  ...
  },
  {
    ...
    evidence: 'evidence/steadytap-native.svg',
    market: 'Accessibility and habit coaching users',
    architectureSignal: 'SwiftUI, inclusive UX, optional backend sync',
    proofPath: 'Runtime walkthrough, repository evidence, architecture notes, and local quality gate',
  },
  {
    title: 'llm-onprem-deployment-kit',
    description: 'Terraform and Helm infrastructure with actual deployment checks and explicit inference boundaries.',
    tech: ['Terraform', 'Kubernetes', 'Helm', 'TLS'],
    github: 'https://github.com/KIM3310/llm-onprem-deployment-kit',
    demo: 'https://kim3310.github.io/llm-onprem-deployment-kit/',
    evidence: 'evidence/onprem-deployment.svg',
    market: 'Engineers reviewing private infrastructure deployments',
    architectureSignal: 'Provider locks, chart contracts, gateway TLS, secret wiring, Kubernetes recovery',
    proofPath: 'Eight Terraform directories, Helm rendering, and a Kubernetes protocol-fixture deployment',
  },
  {
    title: 'kbbq-idle-unity',
    ...
    proofPath: '12 .NET tests, 10 backend tests and integrity checks on the historical 2026-02-20 WebGL build',
  },
  {
    title: 'idlemesh',
