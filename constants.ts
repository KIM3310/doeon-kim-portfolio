...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    category: 'AI Engineer / Enterprise Governance',
    role: 'RAG pipelines, RBAC, eval gates, and multi-cloud IaC for enterprise LLM deployment',
    achievements: [
      'Implemented RBAC, injection detection, PII redaction, audit hash logging, and citation-oriented response controls.',
      'Built JSONL eval pipelines, red-team reporting, and rollout drafts to support enterprise rollout decisions.',
      'Integrated OpenTelemetry for end-to-end trace visibility across governance and rollout workflows.',
    ],
    tech: ['Python', 'FastAPI', 'RAG', 'RBAC', 'Terraform', 'OpenTelemetry'],
    links: { github: 'https://github.com/KIM3310/enterprise-llm-adoption-kit' },
  },
  {
    title: 'Lakehouse Contract Lab',
    category: 'Solutions Architect / Data Engineering',
    role: 'Spark + Delta medallion pipeline with Snowflake and Databricks export',
    achievements: [
      'Built a full medallion-architecture pipeline (bronze/silver/gold) with Spark and Delta Lake.',
      'Implemented data contracts, schema enforcement, and quality gates across pipeline stages.',
      'Delivers warehouse-target export to both Snowflake and Databricks for multi-platform lakehouse readiness.',
    ],
    tech: ['Python', 'PySpark', 'Delta Lake', 'Snowflake', 'Databricks', 'Data Contracts'],
    links: { github: 'https://github.com/KIM3310/lakehouse-contract-lab' },
  },
  {
    title: 'Nexus-Hive — Multi-Agent NL-to-SQL BI Copilot',
    category: 'AI Engineer / Governed Analytics',
    role: 'Multi-agent NL-to-SQL with policy enforcement, audit trails, and semantic metric layer',
    achievements: [
      'Orchestrates multi-agent NL-to-SQL translation with policy enforcement and audit trails.',
      'Implements a semantic metric layer for certified, governed analytics queries.',
      'Provides enterprise BI copilot workflows with full traceability from natural language to SQL execution.',
    ],
    tech: ['Python', 'Multi-Agent', 'NL-to-SQL', 'Policy Enforcement', 'Audit Trails'],
  ...
  },
  {
    ...
    category: 'AI Engineer / Incident Intelligence',
    ...
    achievements: [
      ...
      'Implements replay evaluation framework for consistent regression discipline across incident scenarios.',
      'Generates structured postmortems with severity classification, failure taxonomy, and remediation plans.',
    ],
    tech: ['TypeScript', 'Gemini', 'Multimodal AI', 'Replay Evals', 'GCP'],
  ...
  },
  {
    ...
    category: 'Solutions Architect / Semiconductor Ops',
    role: 'Semiconductor ops platform with dual-domain architecture for alarm triage and yield management',
    achievements: [
      'Built a manufacturing control tower with dual-domain architecture spanning alarm triage and lot-risk workflows.',
      'Implements hold / watch / release-ready posture with signed handoff and release gates.',
      'Consolidated scanner-field-response domain into a unified semiconductor ops surface.',
    ],
    tech: ['Python', 'FastAPI', 'Manufacturing Ops', 'Dual-Domain Architecture'],
