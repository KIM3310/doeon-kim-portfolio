...
export const PROFILE: Profile = {
  ...
  intro: 'AI 시스템 설계부터 데이터 파이프라인, 클라우드 배포, 웹 개발까지 직접 만듭니다. LLM 파인튜닝, RAG, Spark/Snowflake 데이터 엔지니어링, React/FastAPI 풀스택, 그리고 네트워크·보안 관제와 24/7 운영 경험까지. 31개 프로젝트, 3,700+ 테스트.',
};
