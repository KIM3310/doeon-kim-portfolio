...
| Lane | Model | Purpose |
|---|---|---|
| Primary | `openrouter/auto` | Portfolio architecture assistant and repo-selection explainer if a server-side chat is enabled. |
...
OPENROUTER_HTTP_REFERER=https://kim3310-doeon-kim-portfolio.pages.dev
OPENROUTER_APP_TITLE=doeon-kim-portfolio
```
