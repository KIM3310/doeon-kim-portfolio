...
| Architecture signal | architecture clarity, trust boundaries, runtime/data notes, and repeatable operator workflow |
...
| Support handoff | Capture setup, known limits, recovery steps, and customer-specific extension points before production testing. |
...
Turn the repo into a customer-facing workflow by pairing the proof surface with one discovery question, one measurable success metric, and one bounded follow-up path. The smallest viable workflow should be easy to verify and bounded enough to deliver without custom platform work.
