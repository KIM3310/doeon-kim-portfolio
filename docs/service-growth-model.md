# Service Growth Model - doeon-kim-portfolio
...
| Field | Decision |
|---|---|
| Service type | Portfolio and offer router |
| Primary reader or buyer | Technical evaluators, buyers, partners, and design partners. |
| Wedge | Route visitors into architecture-backed pilot conversations without public financial assumptions. |
