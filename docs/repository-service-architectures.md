...
| `lakehouse-contract-lab` | Data contracts and quality gates | Data-contract assessment using sample or redacted datasets | GitHub Pages, architecture inspection Spark/Databricks/Snowflake environment later, R2/S3 artifact storage, CI runner | [service architecture](https://github.com/KIM3310/lakehouse-contract-lab/blob/main/docs/service-architecture.md) |
| `llm-onprem-deployment-kit` | Private LLM deployment readiness | Readiness architecture and reference-architecture mapping | private VPC or architecture inspection cloud, container registry, managed Postgres, vector database | [service architecture](https://github.com/KIM3310/llm-onprem-deployment-kit/blob/main/docs/service-architecture.md) |
...
| `stage-pilot` | Agent runtime reliability | Reliability audit using architecture inspection-provided failure traces or synthetic fixtures | npm package release, GitHub Pages, CI benchmark runner, artifact storage | [service architecture](https://github.com/KIM3310/stage-pilot/blob/main/docs/service-architecture.md) |
...
5. Move private architecture inspection data only after auth, retention, deletion, logging, and rollback paths are documented.
