...
const proofLinks = [
  {
    ...
    helper: 'Current checked-in 40-case benchmark snapshot with public reliability evidence.',
  ...
  return (
    <section id="visitor-mode" className="relative overflow-hidden bg-bg pb-16 pt-28 md:pb-20 md:pt-32 lg:pt-36">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.14)_0,transparent_55%),linear-gradient(135deg,rgba(255,255,255,0.04),rgba(255,255,255,0))] opacity-40"></div>
      </div>
