...
import { PROFILE, PRIMARY_PROOF_URL, FLAGSHIP_URL, RESUME_PDF_URL } from '../constants';
        ...
        <div className="grid gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-stretch">
          ...
          >
            <div className="mb-6 flex items-center justify-between gap-4 border-b border-white/10 pb-5">
              <span className="text-accent-gold text-xs font-medium tracking-[0.3em] uppercase">Primary public proof</span>
              <span className="rounded-full border border-white/10 px-3 py-1 text-[11px] uppercase tracking-[0.22em] text-white/45">Agent reliability · public evals</span>
            </div>
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-3">
              <div className="border border-white/10 bg-black/20 p-4">
                ...
                <p className="mt-2 text-sm text-white">LLM systems · Reliability · Runtime safety</p>
              </div>
              <div className="border border-white/10 bg-black/20 p-4">
                <p className="text-[11px] uppercase tracking-[0.24em] text-white/35">Primary proof</p>
                <p className="mt-2 text-sm text-white">StagePilot</p>
              </div>
              <div className="border border-white/10 bg-black/20 p-4">
                <p className="text-[11px] uppercase tracking-[0.24em] text-white/35">Applied case</p>
          ...
          >
            <div className="mb-6 flex items-center justify-between gap-4 border-b border-white/10 pb-5">
              ...
              <span className="rounded-full border border-white/10 px-3 py-1 text-[11px] uppercase tracking-[0.22em] text-white/45">29.17% to 87.50% to 100.00%</span>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <article className="border border-white/10 bg-black/20 p-4">
                ...
                <p className="mt-2 text-sm text-white">100.00% with one controlled recovery pass</p>
              </article>
            </div>
