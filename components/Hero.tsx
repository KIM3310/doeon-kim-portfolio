        ...
        <div className="grid gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-stretch">
          ...
          >
            <div className="mb-6 flex items-center justify-between gap-4 border-b border-white/10 pb-5">
              ...
              <span className="rounded-full border border-white/10 px-3 py-1 text-[11px] uppercase tracking-[0.22em] text-white/45">GitLab AI Hackathon × SK hynix-ready</span>
            </div>
